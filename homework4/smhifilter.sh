...
# Select only measurements done at midnight
FILTER_FILTERFILENAME_ONLYMIDNIGHT="onlymidnight_$FILTER_FILTEREDFILENAME"
log "Filtering on only measurements taken at exactly midnight, writing to $FILTER_FILTERFILENAME_ONLYMIDNIGHT"
grep '00:00:00' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLYMIDNIGHT
